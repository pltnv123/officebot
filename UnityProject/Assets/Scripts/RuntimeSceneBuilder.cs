...
public sealed class RuntimeSceneBuilder : MonoBehaviour
{
    ...
    private void BuildBoard()
    {
        ...
        Vector3 taskBoardScale = new Vector3(35.8f, 16.3f, 0.24f);
    ...
    private void BuildZones()
    {
        ...
        Cube("Room2DoorFrameTarget", new Vector3(8.75f, 0f, 6.35f), new Vector3(7.95f, 8.35f, 0.74f), Emissive(new Color(0.45f, 0.22f, 0.05f), new Color(1.00f, 0.56f, 0.12f, 1f), 17.2f));
        ...
        Cube("Room2ArrowGlow", new Vector3(8.75f, 1.68f, 6.08f), new Vector3(7.0f, 1.32f, 7.0f), Emissive(new Color(0.5f, 0.24f, 0.06f), new Color(1.0f, 0.70f, 0.18f), 20.4f));
        ...
        Cube("DispatchZoneGlow", new Vector3(-7.5f, 0.02f, 1.5f), new Vector3(8.0f, 0.03f, 7.7f), Emissive(new Color(0.35f, 0.18f, 0.03f), new Color(1.00f, 0.56f, 0.10f, 1f), 6.0f));
    ...
    {
        RenderSettings.ambientMode = AmbientMode.Flat;
        RenderSettings.ambientIntensity = 30.6f;

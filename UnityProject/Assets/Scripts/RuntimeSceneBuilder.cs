...
public sealed class RuntimeSceneBuilder : MonoBehaviour
{
    ...
    private void BuildZones()
    {
        ...
        Cube("Room2DoorFrameTarget", new Vector3(8.75f, 0f, 6.35f), new Vector3(6.75f, 7.15f, 0.62f), Emissive(new Color(0.45f, 0.22f, 0.05f), new Color(1.00f, 0.56f, 0.12f, 1f), 13.6f));
        ...
        Cube("Room2ArrowGlow", new Vector3(8.75f, 1.56f, 6.08f), new Vector3(5.8f, 1.08f, 5.8f), Emissive(new Color(0.5f, 0.24f, 0.06f), new Color(1.0f, 0.70f, 0.18f), 16.8f));
        ...
        Cube("DispatchZoneGlow", new Vector3(-7.5f, 0.02f, 1.5f), new Vector3(6.8f, 0.03f, 6.5f), Emissive(new Color(0.35f, 0.18f, 0.03f), new Color(1.00f, 0.56f, 0.10f, 1f), 3.6f));
    ...
    {
        RenderSettings.ambientMode = AmbientMode.Flat;
        RenderSettings.ambientIntensity = 27.2f;

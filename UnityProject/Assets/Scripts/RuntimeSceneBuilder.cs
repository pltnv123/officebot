...
public sealed class RuntimeSceneBuilder : MonoBehaviour
{
    ...
    private void BuildBoard()
    {
        ...
        Vector3 taskBoardScale = new Vector3(16.2f, 6.5f, 0.24f);
    ...
    private void BuildZones()
    {
        ...
        Cube("Room2DoorFrameTarget", new Vector3(8.75f, 0f, 6.35f), new Vector3(5.75f, 6.15f, 0.52f), Emissive(new Color(0.45f, 0.22f, 0.05f), new Color(1.00f, 0.56f, 0.12f, 1f), 10.9f));
        ...
        Cube("Room2ArrowGlow", new Vector3(8.75f, 1.46f, 6.08f), new Vector3(4.8f, 0.88f, 4.8f), Emissive(new Color(0.5f, 0.24f, 0.06f), new Color(1.0f, 0.70f, 0.18f), 13.8f));
        ...
        Cube("CentralDeskBase", new Vector3(0f, 0f, 0.2f), new Vector3(8.3f, 1.7f, 5.0f), Mat(new Color(0.46f, 0.30f, 0.14f), 0.18f));
        Cyl("CentralDeskEdgeL", new Vector3(-4.65f, 0.96f, 0.2f), new Vector3(0.82f, 1.08f, 0.82f), Mat(new Color(0.42f, 0.28f, 0.14f), 0.15f));
        Cyl("CentralDeskEdgeR", new Vector3(4.65f, 0.96f, 0.2f), new Vector3(0.82f, 1.08f, 0.82f), Mat(new Color(0.42f, 0.28f, 0.14f), 0.15f));
        ...
        Cube("Mon1Screen", new Vector3(7.94f, 1.9f, 0.51f), new Vector3(1.0f, 0.62f, 0.03f), Emissive(new Color(0.08f, 0.22f, 0.16f), new Color(0.18f, 1.00f, 0.78f, 1f), 10.2f));
        Cube("Mon2", new Vector3(8.0f, 1.9f, 1.25f), new Vector3(1.15f, 0.75f, 0.08f), Mat(new Color(0.04f, 0.04f, 0.08f), 0.2f));
        Cube("Mon2Screen", new Vector3(7.94f, 1.9f, 1.21f), new Vector3(1.0f, 0.62f, 0.03f), Emissive(new Color(0.08f, 0.22f, 0.16f), new Color(0.18f, 1.00f, 0.78f, 1f), 10.2f));
        Cube("Mon3", new Vector3(8.0f, 1.9f, 1.95f), new Vector3(1.15f, 0.75f, 0.08f), Mat(new Color(0.04f, 0.04f, 0.08f), 0.2f));
        Cube("Mon3Screen", new Vector3(7.94f, 1.9f, 1.91f), new Vector3(1.0f, 0.62f, 0.03f), Emissive(new Color(0.08f, 0.22f, 0.16f), new Color(0.18f, 1.00f, 0.78f, 1f), 10.2f));
        ...
        Cube("MonitoringWallGlow", new Vector3(8.15f, 1.95f, 1.25f), new Vector3(0.84f, 6.2f, 5.5f), Emissive(new Color(0.04f, 0.16f, 0.10f), new Color(0.20f, 1.00f, 0.72f), 12.2f));
    ...
    {
        RenderSettings.ambientMode = AmbientMode.Flat;
        RenderSettings.ambientIntensity = 9.4f;
        ...
        L("NeonDispatchAccent", LightType.Point, new Color(1.0f, 0.58f, 0.14f), 7.2f, 36f,
            LightShadows.None, new Vector3(-7.6f, 2.8f, 1.4f), Quaternion.identity);
        L("Room2PortalAccent", LightType.Point, new Color(1.0f, 0.60f, 0.16f), 8.6f, 34f,

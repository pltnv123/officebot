...
public sealed class RuntimeSceneBuilder : MonoBehaviour
{
    ...
    private void BuildBoard()
    {
        ...
        Vector3 taskBoardScale = new Vector3(14.6f, 5.7f, 0.24f);
    ...
    private void BuildZones()
    {
        ...
        Cube("Room2DoorFrameTarget", new Vector3(8.75f, 0f, 6.35f), new Vector3(4.95f, 5.35f, 0.44f), Emissive(new Color(0.45f, 0.22f, 0.05f), new Color(1.00f, 0.56f, 0.12f, 1f), 8.9f));
        ...
        Cube("Room2ArrowGlow", new Vector3(8.75f, 1.38f, 6.08f), new Vector3(4.0f, 0.72f, 4.0f), Emissive(new Color(0.5f, 0.24f, 0.06f), new Color(1.0f, 0.70f, 0.18f), 11.4f));
        ...
        Cube("CentralDeskBase", new Vector3(0f, 0f, 0.2f), new Vector3(7.1f, 1.50f, 4.2f), Mat(new Color(0.46f, 0.30f, 0.14f), 0.18f));
        Cyl("CentralDeskEdgeL", new Vector3(-3.85f, 0.88f, 0.2f), new Vector3(0.66f, 0.92f, 0.66f), Mat(new Color(0.42f, 0.28f, 0.14f), 0.15f));
        Cyl("CentralDeskEdgeR", new Vector3(3.85f, 0.88f, 0.2f), new Vector3(0.66f, 0.92f, 0.66f), Mat(new Color(0.42f, 0.28f, 0.14f), 0.15f));
        ...
        Cube("Mon1Screen", new Vector3(7.94f, 1.9f, 0.51f), new Vector3(1.0f, 0.62f, 0.03f), Emissive(new Color(0.08f, 0.22f, 0.16f), new Color(0.18f, 1.00f, 0.78f, 1f), 7.8f));
        Cube("Mon2", new Vector3(8.0f, 1.9f, 1.25f), new Vector3(1.15f, 0.75f, 0.08f), Mat(new Color(0.04f, 0.04f, 0.08f), 0.2f));
        Cube("Mon2Screen", new Vector3(7.94f, 1.9f, 1.21f), new Vector3(1.0f, 0.62f, 0.03f), Emissive(new Color(0.08f, 0.22f, 0.16f), new Color(0.18f, 1.00f, 0.78f, 1f), 7.8f));
        Cube("Mon3", new Vector3(8.0f, 1.9f, 1.95f), new Vector3(1.15f, 0.75f, 0.08f), Mat(new Color(0.04f, 0.04f, 0.08f), 0.2f));
        Cube("Mon3Screen", new Vector3(7.94f, 1.9f, 1.91f), new Vector3(1.0f, 0.62f, 0.03f), Emissive(new Color(0.08f, 0.22f, 0.16f), new Color(0.18f, 1.00f, 0.78f, 1f), 7.8f));
        ...
        Cube("MonitoringWallGlow", new Vector3(8.15f, 1.95f, 1.25f), new Vector3(0.68f, 5.4f, 4.7f), Emissive(new Color(0.04f, 0.16f, 0.10f), new Color(0.20f, 1.00f, 0.72f), 9.8f));
    ...
    private static void BuildLighting()
    {
        ...
        L("NeonDispatchAccent", LightType.Point, new Color(1.0f, 0.58f, 0.14f), 5.6f, 28f,
            LightShadows.None, new Vector3(-7.6f, 2.8f, 1.4f), Quaternion.identity);
        L("Room2PortalAccent", LightType.Point, new Color(1.0f, 0.60f, 0.16f), 6.2f, 26f,

...
public sealed class RuntimeSceneBuilder : MonoBehaviour
{
 ...
 var w = BuildRobot(new Vector3(-1.5f,0f,1.3f), new Color(0.20f,0.95f,0.72f),"WORKER", 35f);
 ...
 BuildRobot(new Vector3(0f,0f,0.5f), new Color(0.35f,0.65f,1.00f),"PLANNER", 0f);
